...
return [
    ...
    */
    ...
    'max' => [
        'numeric' => 'Значение поля :attribute должно быть максимум :max.',
        'file' => 'The :attribute must not be greater than :max kilobytes.',
        'string' => 'Длинна поля :attribute должна быть максимум :max символов.',
    ...
    'min' => [
        ...
        'string' => 'Длина поля :attribute должна быть минимум :min символов.',
        'array' => 'The :attribute must have at least :min items.',
    ],
    'multiple_of' => 'The :attribute must be a multiple of :value.',
    'not_in' => 'The selected :attribute is invalid.',
    'not_regex' => 'The :attribute format is invalid.',
    'numeric' => 'Значение поля :attribute должен быть числом.',
    'password' => 'The password is incorrect.',
    'present' => 'The :attribute field must be present.',
    'regex' => 'Некорректный формат :attribute',
    ...
    */
    ...
    'attributes' => [
        ...
        'root' => 'статуса коренного жителя',
        'stay' => 'стажа проживания на севере',
    ],
