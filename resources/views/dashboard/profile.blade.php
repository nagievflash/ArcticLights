@extends('layouts.dashboard', ['sTitle' => __('dashboard.profile-title')])
        ...
        <div class="text-page__content" style="opacity: 1;">
            <div class="row">
                <div class="text-block text-block--dark">
                    <h3 class="heading heading--dark heading--ms desktop">{{ __('dashboard.profile-form-title') }}</h3>
                    <form class="form js-ajax-form" autocomplete="off" method="POST" action="{{Route('profile')}}">
                        ...
                        <div class="contacts__slide">
                            ...
                            <div class="form__control form__control--m">
                                <input id="phone" name="phone" class="form__input" type="text" placeholder="Телефон"
                            ...
                            <div class="form__control form__control--m">
                                <input id="age" name="age" class="form__input" type="text" placeholder="Возраст (лет)*"
                                       value="{{ old('age') ?? Auth::user()->age ?? '' }}" required>
                            </div>

                            <div class="form__control form__control--m">
                                <input id="sex" name="sex" class="form__input" type="text" placeholder="Пол*"
                                       value="{{ old('sex') ?? Auth::user()->sex ?? '' }}" required>
                            </div>
                            ...
                            <div class="form__control form__control--">
                                <input id="stay" name="stay" class="form__input" type="number"
